...
urlpatterns = [
    ...
    path('mealcategories/', views.MealCategoriesAPIView.as_view(), name = 'mealcategories'),
    path('mealcategories/<int:pk>', views.MealCategoriesDetail.as_view(), name = 'mealcategories_detail'),
    ...
    path('servicepercentage/', views.ServicePercentageAPIView.as_view(), name = 'servicepercentage'),
    ...
    path('mealstoorder/<int:pk>', views.MealsToOrderDetail.as_view(), name = 'mealstoorder_detail'),
    path('categoriesByDepartment/<int:pk>/', views.MealCategoriesByDepartment.as_view(), name = 'categoriesByDepartment'),
]